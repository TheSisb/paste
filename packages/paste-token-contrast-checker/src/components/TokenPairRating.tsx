  ...
  return (
    ...
    >
      <MediaObject verticalAlign="center" key={uidSeed('text')}>
        ...
        <MediaBody>
          <Box
            backgroundColor={toCamelCase(background) as BackgroundColorOptions}
            color={toCamelCase(foreground) as TextColorOptions}
            padding="space40"
            minWidth="0"
            display="flex"
          ...
          >
            <Box
              ...
              borderColor={toCamelCase(foreground) as BorderColorOptions}
              display="flex"
            ...
            >
              ...
              <Box minWidth="0" marginLeft="space20">
                <div>
                  <Truncate>{foreground}</Truncate>
                </div>
                <div>on</div>
                <div>
                  <Truncate>{background}</Truncate>
                </div>
              </Box>
            </Box>
          </Box>
